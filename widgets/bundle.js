  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "ul",
        { id: "tab-bar" },
        this.props.tabHeaders.map(function (obj, i) {
          if (i === _this2.props.selected) {
            return _react2.default.createElement(
              "h1",
              { key: i, id: "selected-tab" },
              obj
            );
          } else {
            return _react2.default.createElement(
...
var _header = __webpack_require__(/*! ./header */ "./frontend/header.jsx");
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    key: 'render',
    value: function render() {
      var selectedTab = this.state.tabs[this.state.selectedTab];
      // const tabBar
      var tabHeaders = this.state.tabs.map(function (obj) {
        return obj.title;
      });
      return _react2.default.createElement(
        'div',
        { id: 'tabs-container' },
        _react2.default.createElement(_header2.default, { tabHeaders: tabHeaders, selected: this.state.selectedTab }),
        _react2.default.createElement(
          'article',
          { id: 'tab-content' },
          _react2.default.createElement(
...
var _clock = __webpack_require__(/*! ./frontend/clock */ "./frontend/clock.jsx");

var _clock2 = _interopRequireDefault(_clock);

var _tabs = __webpack_require__(/*! ./frontend/tabs */ "./frontend/tabs.jsx");
...
var Root = function Root() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_tabs2.default, { tabs: [{ title: 'tab1', content: 'content1' }, { title: 'tab2', content: 'content2' }, { title: 'tab3', content: 'content3' }] })
  );
};
...
var _root = __webpack_require__(/*! ./root */ "./root.jsx");
